...
public void transferUang(int jumlah, String rekeningTujuan, String bankTujuan, String berita){
    ...
    if (saldo >= jumlah + biaya){
        saldo -= jumlah + biaya;
        System.out.println("Transfer berhasil dari rekening " + this.nama + " ke bank " + bankTujuan + " dengan nomor rekening " + rekeningTujuan + berita);
        System.out.println("Dengan nominal Rp " + jumlah);
        System.out.println("Biaya admin Rp " + biaya + " dan sisa saldo anda Rp " + this.saldo); 
    } else {
        System.out.println("Gagal!! salso anda tidak mencukupi");
    }
}
